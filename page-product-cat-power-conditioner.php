...
<main class="taxonomy-product-cat power-conditioner single-products">
  <section class="mv mv-power-conditioner">
    <div class="container">
      <div class="ttlc">
  ...
  <section class="top">
    <div class="container">
      <div class="prod-img"><img src="<?=$img_path?>/tax-prod-cat/pi-power-conditioner.png" alt=""></div>
    </div>
  </section>
  <!-- // TOP -->

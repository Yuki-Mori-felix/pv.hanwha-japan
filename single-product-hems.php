...
<main class="single-products hems">
          ...
          <div class="left">
            ...
            <?php if (get_field('hems_banner')): ?>
              <a href="<?= get_field('hems_banner'); ?>" class="eneconnect-banner">
                <img src="<?= $home_url; ?>/wp-content/uploads/2025/05/ENECONECT_banner_01.png" alt="エネコネクトの節電サポート 詳しくはこちら">
              </a>
            <?php endif; ?>
          </div>
          <div class="right">
          ...
          <ul class="flow">
            <li class="step">
              ...
              <div class="accordion typeB">
                ...
                <div class="accordion-content">
                  <p class="txt">
                    ・エネコネクトのウェブサイトのお問い合わせフォームをご記入ください。<br />
                    ・担当者から確認後ご連絡します。
                  </p>
                </div>
              </div>
  ...
  <a href="<?= home_url(); ?>/proudct-list/hems/" class="banner">
    <img src="<?= $img_path ?>/single-product/HEMS_Product details_banner.webp" alt="蓄電システム・HEMS 製品一覧ページへ">
  </a>
